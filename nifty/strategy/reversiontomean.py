...
# ---- CONFIGURATION ---- # 
LOT_SIZE_CASH = 5000    # Rs per lot per buy trigger 
PROFIT_TARGET = 5/100   # 5% above average buy price to trigger sell 

class ReversionToMean:
    # -- Helper: Calculate trigger prices -- # 
    def get_triggers(ref_price,ref_price_1,ref_price_2,ref_price_3): 
        return [ 
    ...
    # ---- STRATEGY LOGIC ---- # 
    def run_nifty_shop(prices_df, ref_price_1, ref_price_2,ref_price_3 ,lot_size_cash=LOT_SIZE_CASH, profit_target=PROFIT_TARGET): 
        trade_log = [] 
        ...
        for day, row in prices_df.iterrows(): 
            ...
            for stock in prices_df.columns: 
                ...
                if not ref_price: 
                    continue 
                triggers = ReversionToMean.get_triggers(ref_price,ref_price_1,ref_price_2,ref_price_3) 
